...
class DefaultArticleRepository(
    private val articlesRemoteDataSource: ArticleDataSource,
    private val articlesLocalDataSource: ArticleDataSource?,
    ...
    private suspend fun updateArticlesFromRemoteDataSource(page: Int) {
        ...
        if (remoteArticles is NetworkResult.Success) {
            ...
            remoteArticles.data.forEach { article ->
                articlesLocalDataSource?.saveArticle(article)
            }
