...
object ServiceLocator {
    ...
    @Volatile
    private var articleApi: NetworkApi? = null
    ...
    fun provideArticleApi(): NetworkApi {
        synchronized(this) {
    ...
    private fun createApi(): NetworkApi {
        return RetrofitHelper.buildApi(NetworkApi::class.java)
    }
