...
/// 流式布局
class MyWrapFlow extends StatelessWidget {
  const MyWrapFlow({super.key});
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(
        ...
        body: Center(child: showWrap ? buildWrap() : buildFlow()),
      ),
    );
  }

  Widget buildWrap() => const Wrap(
        children: <Widget>[
          Chip(
            avatar:
