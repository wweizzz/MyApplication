...
import com.example.william.my.module.sample.paging.viewmodel.PagingViewModel
...
class PagingActivity : BaseVBActivity<SampleActivityPagingBinding>() {
    ...
    private val mViewModel: PagingViewModel by viewModels {
        object : ViewModelProvider.Factory {
            override fun <T : ViewModel> create(modelClass: Class<T>): T {
                ...
                return PagingViewModel(database, networkApi, repository) as T
            }
        }
    }
    ...
    private fun initArticles(viewModel: PagingViewModel, adapter: PagingAdapter) {
    ...
    private fun initArticleFlow(viewModel: PagingViewModel, adapter: PagingAdapter) {
        lifecycleScope.launch {
    ...
    private fun initArticleFlowable(viewModel: PagingViewModel, adapter: PagingAdapter) {
    ...
    private fun initArticleLiveData(viewModel: PagingViewModel, adapter: PagingAdapter) {
