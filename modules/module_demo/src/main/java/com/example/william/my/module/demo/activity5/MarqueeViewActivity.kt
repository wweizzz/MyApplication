...
import com.example.william.my.module.demo.databinding.DemoActivityMarqueeBinding

@Route(path = ARouterPath.Demo.MarqueeView)
class MarqueeViewActivity : BaseVBActivity<DemoActivityMarqueeBinding>() {

    override fun getViewBinding(): DemoActivityMarqueeBinding {
        return DemoActivityMarqueeBinding.inflate(layoutInflater)
    }
