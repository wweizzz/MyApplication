...
class DemoActivity : RouterRecyclerActivity() {
    ...
    override fun buildRouter(): ArrayList<RouterItem> {
        ...
        routerItems.add(RouterItem("FragmentViewPager", ARouterPath.Demo.FragmentViewPager))
        routerItems.add(RouterItem("RecyclerViewNested", ARouterPath.Demo.RecyclerViewNested))
        routerItems.add(RouterItem(" ", ""))
        ...
        routerItems.add(RouterItem("TransitionAnim", ARouterPath.Demo.TransitionAnim))
        ...
        routerItems.add(RouterItem("AlertDialog", ARouterPath.Demo.AlertDialog))
        routerItems.add(RouterItem("BlurView", ARouterPath.Demo.BlurView))
        routerItems.add(RouterItem("InfiniteImage", ARouterPath.Demo.InfiniteImage))
        routerItems.add(RouterItem("MarqueeView", ARouterPath.Demo.MarqueeView))
        routerItems.add(RouterItem("Sensor3DView", ARouterPath.Demo.Sensor3DView))
        routerItems.add(RouterItem("Spinner", ARouterPath.Demo.Spinner))
        routerItems.add(RouterItem("TitleBar", ARouterPath.Demo.TitleBar))
        routerItems.add(RouterItem("VerifyCode", ARouterPath.Demo.VerifyCode))
        return routerItems
    }
}