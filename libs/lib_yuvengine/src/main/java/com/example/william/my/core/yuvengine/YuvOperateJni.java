package com.example.william.my.core.yuvengine;
...
public class YuvOperateJni {
    ...
    public static native void I420ClockWiseRotate90(long cPtr, byte[] pI420, int srcWidth, int srcHeight, byte[] outData, int[] outWidth, int[] outHeight);

    //YV12图像顺时针旋转90度
    public static native void Yv12ClockWiseRotate90(long cPtr, byte[] pYv12, int srcWidth, int srcHeight, byte[] outData, int[] outWidth, int[] outHeight);
