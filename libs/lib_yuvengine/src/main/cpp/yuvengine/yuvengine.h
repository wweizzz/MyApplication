...
public:
     ...
     **/
    void
    cutCommonYuv(int yuvType, int startX, int startY, unsigned char *srcYuv, int srcW, int srcH,
                 unsigned char *tarYuv, int cutW, int cutH);
     ...
     **/
    void
    getSpecYuvBuffer(int yuvType, unsigned char *dstBuf, unsigned char *srcYuv, int srcW, int srcH,
                     int dirty_Y, int dirty_UV);
     ...
     */
    void
    Nv21ClockWiseRotate90(unsigned char *pNv21, int srcWidth, int srcHeight, unsigned char *outData,
    ...
    * outHeight 旋转后对应的高
    */
    void Nv21ClockWiseRotate180(unsigned char *pNv21, int srcWidth, int srcHeight,
    ...
    * outHeight 旋转后对应的高
    */
    void Nv21ClockWiseRotate270(unsigned char *pNv21, int srcWidth, int srcHeight,
                                unsigned char *outData, int *outWidth, int *outHeight);
   ...
   */
    void
    I420ClockWiseRotate90(unsigned char *pI420, int srcWidth, int srcHeight, unsigned char *outData,
                          int *outWidth, int *outHeight);
    ...
    */
    void
    Nv12ClockWiseRotate90(unsigned char *pNv12, int srcWidth, int srcHeight, unsigned char *outData,
                          int *outWidth, int *outHeight);
  ...
  */
    void
    Yv12ClockWiseRotate90(unsigned char *pYv12, int srcWidth, int srcHeight, unsigned char *outData,
                          int *outWidth, int *outHeight);
};
